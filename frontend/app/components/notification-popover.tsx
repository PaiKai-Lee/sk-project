...
import type { IUserNotification, IUserNotificationsResponse } from '~/api/types';
                        ...
                        <ScrollArea className="h-96">
                            ...
                            {userNotificationQuery.data &&
                                userNotificationQuery.data.pages.map((page, idx) => (
                                    <Fragment key={idx}>
                                        {page.rows.length > 0 ? (
                                            page.rows.map((userNotification) => <UserNotificationItem key={userNotification.id} userNotification={userNotification} />
                                            )
                                        ) : (
...
function UserNotificationItem({ userNotification }: { userNotification: IUserNotification }) {
    return (
        <div
